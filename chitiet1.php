                        ...
                        <div class="content-product__info">
                            <div class="row4">
                                ...
                                <div class="cat__slides">
                                        ...
                                        <img src="images/<?php echo $row['img1'] ?>" style="width:100%;height: 380px;" >      </div>
                                      
                                        <div class="mySlides_cat">
                                          <img src="images/<?php echo $row['img2'] ?>" style="width:100%;height: 380px;">
                                        </div>
                                      
                                        <div class="mySlides_cat">
                                          <img src="images/<?php echo $row['img3'] ?>" style="width:100%;height: 380px;">
                                        </div>

                                        <div class="mySlides_cat">
                                            <img src="images/<?php echo $row['img4'] ?>" style="width:100%;height: 380px;">
                                        </div>
                                          
                                      
                                        <div class="row_cat">
                                          <div class="column">
                                          <img src="images/<?php echo $row['img1'] ?>" alt=""  class="container-product__items-img" style="width:100%;height: 80px;" onclick="currentSlide(1)" alt="Cinque Terre">         </div>
                                          <div class="column">
                                            <img class="demo cursor" src="images/<?php echo $row['img2'] ?>" style="width:100%;height: 80px;" onclick="currentSlide(2)" alt="Cinque Terre">
                                          </div>
                                          <div class="column">
                                            <img class="demo cursor" src="images/<?php echo $row['img3'] ?>" style="width:100%;height: 80px;" onclick="currentSlide(3)" alt="Mountains and fjords">
                                          </div>
                                          <div class="column">
<img class="demo cursor" src="images/<?php echo $row['img4'] ?>" style="width:100%;height: 80px;" onclick="currentSlide(4)" alt="Mountains and fjords">
                                          </div>
                ...
                <div class="content__describe">
                    ...
                    <div class="content__describe-info">
                        <p class="content__describe-msg">
                            <b>Tên Mô Hình:</b> <?php echo $row["tensp"] ?> <br>
                        ...
                        <p class="content__describe-msg">
                            <b>Bảo hành:</b>  <?php echo $row["cachchamsoc"] ?>
                        </p>
                        <p class="content__describe-msg">
                        <b>Phân Loại:</b>  <?php echo $row["giongloai"] ?>
                        </p>
                        <p class="content__describe-msg">
